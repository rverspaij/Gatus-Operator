...
import (
	...
	"github.com/rverspaij/Gatus-Operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "5f19b4e4.gatus-operator.dev",
	...
	if err := (&controller.GatusCheckReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "GatusCheck")
		os.Exit(1)
	}
